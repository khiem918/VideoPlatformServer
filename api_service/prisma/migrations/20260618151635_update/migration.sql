/*
  ...
  - The values [UPDATED] on the enum `UploadMetaStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "core"."UploadMetaStatus_new" AS ENUM ('PENDING', 'PROCESSED');
